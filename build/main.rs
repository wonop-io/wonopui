...
fn main() {
    ...
    let default_config = Config {
        ...
        alert_title: get_default_value("alert_title", &default_config_hm),
        alert_description: get_default_value("alert_description", &default_config_hm),
        ...
        kanban_container: get_default_value("kanban_container", &default_config_hm),
        kanban_column: get_default_value("kanban_column", &default_config_hm),
        kanban_column_header: get_default_value("kanban_column_header", &default_config_hm),
        kanban_column_body: get_default_value("kanban_column_body", &default_config_hm),
        kanban_column_over: get_default_value("kanban_column_over", &default_config_hm),
        kanban_card: get_default_value("kanban_card", &default_config_hm),
        ...
        sidebar_heading: get_default_value("sidebar_heading", &default_config_hm),
        sidebar_menu: get_default_value("sidebar_menu", &default_config_hm),
        sidebar_item_base: get_default_value("sidebar_item_base", &default_config_hm),
        sidebar_item_hover: get_default_value("sidebar_item_hover", &default_config_hm),
        sidebar_item_active: get_default_value("sidebar_item_active", &default_config_hm),
        sidebar_link_base: get_default_value("sidebar_link_base", &default_config_hm),
        sidebar_link_active: get_default_value("sidebar_link_active", &default_config_hm),
        sidebar_header: get_default_value("sidebar_header", &default_config_hm),
        sidebar_footer: get_default_value("sidebar_footer", &default_config_hm),

...
pub struct BrandConfig {
    ...
    pub kanban_container: String,
    pub kanban_column: String,
    pub kanban_column_header: String,
    pub kanban_column_body: String,
    pub kanban_column_over: String,
    pub kanban_card: String,
    pub kanban_card_title: String,
    pub kanban_card_content: String,
    pub kanban_card_dragging: String,

    pub markdown_editor_container: String,
    pub markdown_editor_blocks_container: String,
    pub markdown_editor_block: String,
    pub markdown_editor_block_active: String,
    pub markdown_editor_paragraph: String,
    pub markdown_editor_heading1: String,
    pub markdown_editor_heading2: String,
    pub markdown_editor_heading3: String,
    pub markdown_editor_bullet_list: String,
    pub markdown_editor_numbered_list: String,
    pub markdown_editor_quote: String,
    pub markdown_editor_code: String,
    pub markdown_editor_divider: String,
    pub markdown_editor_divider_block: String,
    pub markdown_command_menu_container: String,
    ...
    pub sidebar_menu: String,
    pub sidebar_item_base: String,
    pub sidebar_item_hover: String,
    pub sidebar_item_active: String,
    pub sidebar_link_base: String,
    pub sidebar_link_active: String,
    pub sidebar_header: String,
    pub sidebar_footer: String,
...
impl BrandConfig {
    pub fn write_config_to_file(self, filename: &PathBuf) -> Result<(), Box<dyn Error>> {
        ...
        write_fields!(
            ...
            markdown_editor_block,
            markdown_editor_block_active,
            markdown_editor_paragraph,
            markdown_editor_heading1,
            markdown_editor_heading2,
            markdown_editor_heading3,
            markdown_editor_bullet_list,
            markdown_editor_numbered_list,
            markdown_editor_quote,
            markdown_editor_code,
            markdown_editor_divider,

...
pub fn get_default_config() -> Result<HashMap<String, String>> {
    let elements = vec![
        ...
        ("combobox_item".to_string(), "px-8 cursor-pointer hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-white".to_string()),
        ...
        ("combobox_heading".to_string(), "px-4 py-1 text-xs font-semibold text-foreground/70 uppercase [&:not(:first-child)]:pt-4".to_string()),

...
pub mod classes {
    ...
    pub const POSITION_NORTH_END: &str = "bottom-full right-0 mb-2";
    pub const POSITION_SOUTH_START: &str = "top-full left-0 mt-2";
    pub const POSITION_SOUTH_MIDDLE: &str = "top-full left-1/2 -translate-x-1/2 mt-2";
    pub const POSITION_SOUTH_END: &str = "top-full right-0 mt-2";
    pub const POSITION_EAST_START: &str = "left-full top-0 ml-2";
    pub const POSITION_EAST_MIDDLE: &str = "left-full top-1/2 -translate-y-1/2 ml-2";
    pub const POSITION_EAST_END: &str = "left-full bottom-0 ml-2";
    pub const POSITION_WEST_START: &str = "right-full top-0 mr-2";
    pub const POSITION_WEST_MIDDLE: &str = "right-full top-1/2 -translate-y-1/2 mr-2";
    pub const POSITION_WEST_END: &str = "right-full bottom-0 mr-2";
}
...
pub fn popover(props: &PopoverProps) -> Html {
    ...
    html! {
        <ContextProvider<Rc<PopoverState>> context={state}>
            <div ref={div_ref} class={class} tabindex="0" onfocusout={close}>

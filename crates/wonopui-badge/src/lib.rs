...
pub mod classes {
    ...
    pub const WARNING: &str = "border-transparent bg-amber-100 text-amber-900 dark:bg-amber-900/30 dark:text-amber-400";
    
    /// Error badge variant.
    pub const ERROR: &str = "border-transparent bg-red-100 text-red-900 dark:bg-red-900/30 dark:text-red-400";
    
    /// Info badge variant.
    pub const INFO: &str = "border-transparent bg-blue-100 text-blue-900 dark:bg-blue-900/30 dark:text-blue-400";
}

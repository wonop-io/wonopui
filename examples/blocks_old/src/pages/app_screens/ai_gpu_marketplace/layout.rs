...
pub struct AIDecentralisedGpuMarketLayoutProps {
    #[prop_or_default]
...
#[function_component(AiGpuMarketplaceSidebar)]
pub fn ai_gpu_marketplace_sidebar() -> Html {
    ...
    html! {
        <Sidebar
            ...
            <SidebarHeading title={"Marketplace"} />
            <SidebarMenu>
                <SidebarItem label={"Wallet Balance Management"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"API Key Management"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Backend Routing"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Training Data Collection"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Security"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"User Management"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Resource Sharing"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Resource Monitoring"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Task Management"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Payment Integration"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
                <SidebarItem label={"Network Analytics"} icon={html!{
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                        <path d="M12 2v20M2 12h20"></path>
                    </svg>
                }} />
...
#[function_component(AIDecentralisedGpuMarketLayout)]
pub fn ai_gpu_marketplace_layout(props: &AIDecentralisedGpuMarketLayoutProps) -> Html {
    let user_menu = vec![
        DropdownItemProps {
    ...
    html! {
        <LayoutProvider initial_state={props.initial_state.clone()}>
            <Layout
                sidebar={html! { <AiGpuMarketplaceSidebar /> }} topbar={html!{
                <Topbar>

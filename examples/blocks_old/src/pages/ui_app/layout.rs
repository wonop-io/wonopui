            ...
            <li class="relative mt-6 md:mt-0">
                ...
                */
                <ul role="list" class="border-l border-transparent">
                    ...
                    <li class="relative">
                        <Link<Route> to={Route::AlertExamples} classes="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white">
                            <span class="truncate">{"Alerts"}</span>
                        </Link<Route>>
                    </li>
                    <li class="relative">
                        <Link<Route> to={Route::AvatarExamples} classes="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white">
